 ...
 * This script runs before client.js to ensure a user identity is established
 * before attempting to connect to the chat server.
 */

// --- DOMContentLoaded Listener ---
// Ensures the DOM is fully loaded before we try to manipulate it.
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initUserIdentity() {
        ...
        if (storedUser && storedUser.id && storedUser.name) {
            ...
            document.dispatchEvent(new CustomEvent('userReady', { detail: storedUser }));
        } else {
    ...
    function joinChat() {
        ...
        try {
            ...
            document.dispatchEvent(new CustomEvent('userReady', { detail: newUser }));
        } catch (error) {
